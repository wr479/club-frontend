...
function triaglesFunc() {
        if (activeId === 'label1') {
            ...
            border1.style.backgroundImage = 'url(./services/active-label.png)'; 
            pic2.style.display = 'none';
            border2.style.backgroundImage = 'url(./services/passive-label.png)';
            pic3.style.display = 'none';
            border3.style.backgroundImage = 'url(./services/passive-label.png)';
        } else if (activeId === 'label2') {
            pic1.style.display = 'none';
            border1.style.backgroundImage = 'url(./services/passive-label.png)';
            pic2.style.display = 'block';
            border2.style.backgroundImage = 'url(./services/active-label.png)';
            pic3.style.display = 'none';
            border3.style.backgroundImage = 'url(./services/passive-label.png)';
            ...
            border3.style.backgroundImage = 'url(./services/active-label.png)';
        };
